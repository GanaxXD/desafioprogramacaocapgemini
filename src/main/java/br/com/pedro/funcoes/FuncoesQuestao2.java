...
public class FuncoesQuestao2 {
    public FuncoesQuestao2(){}
    
    
    /*
     * Depois de recebida a senha, serão feitas as verificações indicadas.
     ...
     */
    public static void validaSenha(String senhaDigitada){
